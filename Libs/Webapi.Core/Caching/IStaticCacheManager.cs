...
namespace Webapi.Core
{
    ...
    public interface IStaticCacheManager : IDisposable
    {
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        CacheKey PrepareKey<T>(string keyTemplate, params object[] cacheKeyParameters) where T : BaseEntity;
        ...
        /// <summary>
        /// Create a cache key using the default cache time and fills it by passed parameters
        /// </summary>
        /// <param name="keyTemplate"></param>
        /// <param name="cacheKeyParameters"></param>
        /// <returns></returns>
        CacheKey PrepareKeyForDefaultCache<T>(string keyTemplate, params object[] cacheKeyParameters) where T : BaseEntity;
        ...
        /// <param name="cacheKeyParameters"></param>
        /// <returns></returns>
        CacheKey PrepareKeyForShortTermCache<T>(string keyTemplate, params object[] cacheKeyParameters) where T : BaseEntity;
        #endregion
    }
}
