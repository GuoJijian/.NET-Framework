...
namespace Webapi.Data.Services
{
    ...
    public partial interface ISettingService
    {
        ...
        /// </returns>
        Task<Setting> GetSettingByIdAsync(uint settingId);
        ...
        /// <param name="moduleId">Store identifier</param>
        /// <param name="loadSharedValueIfNotFound">A value indicating whether a shared (for all stores) value should be loaded if a value specific for a certain is not found</param>
        /// <returns>
        /// A task that represents the asynchronous operation
        /// The task result contains the setting
        /// </returns>
        Task<Setting> GetSettingAsync(string key, int moduleId = 0, bool loadSharedValueIfNotFound = false);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SetSettingAsync<T>(string key, T value, int moduleId = 0, bool clearCache = true);
        ...
        /// </summary>
        /// <typeparam name="T">Type</typeparam>
        /// <param name="moduleId">Store identifier for which settings should be loaded</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task<T> LoadSettingAsync<T>(int moduleId = 0) where T : ISettings, new();
        ...
        /// <param name="moduleId">Store identifier for which settings should be loaded</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task<ISettings> LoadSettingAsync(Type type, int moduleId = 0);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SaveSettingAsync<T>(T settings, int moduleId = 0) where T : ISettings, new();
        ...
        /// <param name="settings">Settings</param>
        /// <param name="keySelector">Key selector</param>
        /// <param name="moduleId">Store ID</param>
        /// <param name="clearCache">A value indicating whether to clear cache after setting update</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        ...
        Task SaveSettingOverridablePerStoreAsync<T, TPropType>(T settings,
            Expression<Func<T, TPropType>> keySelector,
            bool overrideForStore, int moduleId = 0, bool clearCache = true) where T : ISettings, new();
